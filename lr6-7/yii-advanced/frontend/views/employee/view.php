                    ...
                    <div class="col-8 text-center">
                        <div class="row">
                            <div class="col-sm-6 text-center">
                                ...
                                ?>
                                <div class="mt-3">
                                    <?= Html::a('Редагувати картинку', ['update-image', 'id' => $model->employee_id], ['class' => 'btn btn-dark']) ?>
                                </div>
                                <div class="mt-3">
                                    <?= Html::a('Видалити картинку', ['delete-image', 'id' => $model->employee_id], ['class' => 'btn btn-dark']) ?>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <?= DetailView::widget([
                                ...
                                <p>
                                    <?= Html::a('Редагувати профіль', ['update', 'id' => $model->employee_id], ['class' => 'btn btn-dark']) ?>
